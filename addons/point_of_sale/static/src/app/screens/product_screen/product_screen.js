...
export class ProductScreen extends ControlButtonsMixin(Component) {
    ...
    getNumpadButtons() {
        return [
            ...
            { value: "2" },
            { value: "3" },
            { value: "quantity", text: "Adet" },
            { value: "4" },
            { value: "5" },
            { value: "6" },
            { value: "discount", text: "% İskonto", disabled: !this.pos.config.manual_discount },
            { value: "7" },
            { value: "8" },
            { value: "9" },
            { value: "price", text: "Fiyat", disabled: !this.pos.cashierHasPriceControlRights() },
            { value: "-", text: "+/-" },
            { value: "0" },
